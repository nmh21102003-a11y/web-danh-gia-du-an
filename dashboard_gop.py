...
def plot_stacked_chart(df_long, col_tc, list_cows, x_axis_title="Thành viên", is_week_view=True):
    ...
    # --- PHẦN TÍNH TOÁN ĐỂ CĂN GIỮA SỐ TRUYỆT ĐỐI ---
    ...
    bars = base.mark_bar(size=40).encode(
        ...
        order=alt.Order('tc_cat_sort:O', sort='ascending'), # <-- CHÌA KHÓA CĂN CHUẨN Ở ĐÂY
        tooltip=[x_axis_title, col_tc, 'Điểm']
    )
    
    # Lớp chữ: Canh giữa, màu trắng, loại bỏ số 0, trỏ vào đúng tọa độ mid_y
