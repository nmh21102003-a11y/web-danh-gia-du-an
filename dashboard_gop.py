# Thay thế hàm plot_stacked_chart cũ bằng hàm này trong file của bạn:
...
def plot_stacked_chart(df_long, list_cows, col_tc):
    ...
    return alt.Chart(df_chart).mark_bar(size=40).encode(
        ...
        color=alt.Color(f'{col_tc}:N', 
                        ...
                        legend=alt.Legend(title="Tiêu chí", orient='bottom', labelLimit=800)),
